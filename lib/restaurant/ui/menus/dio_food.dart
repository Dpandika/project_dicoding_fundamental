...
class DioFood extends StatelessWidget {
  final dynamic foodMenu;
  final String pictureId;

  const DioFood(
      {required this.foodMenu, required this.pictureId, Key? key})
      : super(key: key);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: ListView.builder(
                          itemCount: foodMenu.foods?.length,
                          shrinkWrap: true,
                          physics: const BouncingScrollPhysics(),
                          itemBuilder: (context, index) {
                            final food = foodMenu.foods[index];
                            return Padding(
                              padding:
